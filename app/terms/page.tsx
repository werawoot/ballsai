    ...
    <main className="bds-page" style={{ background: '#f8f8f8', minHeight: '100vh', paddingBottom: 40 }}>
      ...
      <div className="bds-content" style={{ padding: 20, maxWidth: 760, margin: '0 auto' }}>
        <div className="bds-card" style={{ background: 'white', borderRadius: 16, border: '1.5px solid #e5e5e5', padding: 24, boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
          ...
          <p style={{ fontSize: 13, color: '#888', marginBottom: 20 }}>ฉบับ Closed Beta สำหรับ BallDoenSai.com</p>

          {[
            ['การใช้งานระบบ', 'BallDoenSai.com เป็นแพลตฟอร์มสำหรับจัดการแข่งขัน สมัครทีม อัปโหลดหลักฐานการชำระเงิน และจัดอันดับนักกีฬาในช่วงทดสอบ Closed Beta'],
            ...
            ['การชำระเงิน', 'BallDoenSai.com ช่วยจัดเก็บหลักฐานการชำระเงิน การคืนเงินหรือข้อพิพาทให้เป็นไปตามเงื่อนไขของผู้จัดแต่ละรายการ'],
